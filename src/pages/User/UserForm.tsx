  ...
  return (
    ...
    >
      <div className="grid grid-cols-3 gap-12">
        <Span title="Ticket Number" placeHolderText="#######"></Span>
        ...
        <Span title="Created by">{profile?.name}</Span>

        <Span title="Status" placeHolderText="Open"></Span>
        ...
        <Span title="Assigned to" placeHolderText="NA"></Span>
